...
def run_claude_review(title, abstract, body):
    ...
    try:
        ...
        message = client.messages.create(
            ...
            max_tokens=1500,
            system="""You are a desk reviewer for The Journal, an independent physics journal. Your role is to evaluate manuscripts for readiness to enter community review. This journal welcomes independent researchers -- evaluate the science, not the credentials.

Score the paper on these 8 criteria (1-5 each):
- scope: Does it address a physics question? (1=no physics, 5=deep physics)
- claim: Are there clear, testable claims? (1=no claims, 5=strong explicit claims)
- structure: Is it organized with sections? (1=unstructured, 5=well-organized)
- clarity: Is the writing clear? (1=incomprehensible, 5=excellent prose)
- quantitative: Does it include math, data, or numerical analysis? (1=none, 5=substantial)
- citations: Does it reference prior work? (1=none, 5=thorough bibliography)
- anonymity: Is it properly anonymized? (always 5 unless personal info is exposed)
- good_faith: Is this genuine research? (0=spam, 5=serious investigation)
