...
- scope: Does it address a genuine scientific question with appropriate depth? Look for physical/scientific reasoning, not just terminology. A paper spanning multiple domains with empirical evidence scores high.
...
- citations: Does it engage with prior literature? Count the actual references listed. 5+ substantive references engaging with the field = 3+. 10+ = 4+. Quality of engagement matters more than quantity.
