...
def run_desk_review(title, abstract, body):
    ...
    # Expanded scope terms covering broad physics vocabulary
    terms = [
        ...
        'renormalization', 'gauge', 'lagrangian', 'action', 'variational',
    ...
    # More generous scoring formulas
    scores = {
    ...
    if scores['claim'] < 3:
        suggestions.append('State your central claim more explicitly (e.g., "We show that...").')
